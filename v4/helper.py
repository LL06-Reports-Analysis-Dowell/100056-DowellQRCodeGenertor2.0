...
def qrcode_type_defination(qrcode_id_encrypted, qrcode_type, request, qrcode_color, logo, field, logo_url=None):
    serializer = None    
    if qrcode_type == "Product":
        ...
        img_qr = create_qrcode(f"This QrCode is encrypted with {qrcode_id_encrypted}. Decrypt it then Activate and Rescan.", qrcode_color, logo)
